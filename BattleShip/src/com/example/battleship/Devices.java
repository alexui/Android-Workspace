...
class MyAdapter extends BaseAdapter
{
	...
	private ArrayList<BDevice> myList;
	
	public MyAdapter(Activity context, ArrayList<BDevice> list){
...
public class Devices extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(int k=0;k<nr;k++){
			mArrayAdapter.add(new BDevice(i.getStringExtra("name"+k), "address"+k));
		}
